...
const Header = () => {
  ...
  return (
    <div style={{ marginTop: "20px", display: "flex" }}>
      ...
      <div className="dropdown" style={{margin:'0 0 0 auto'}}>
        <i
        ...
        >
          {
            cartlist.length > 0 ? 
            (showDropdown(), 
            <span className="badge badge-dark" style={{fontSize: '35%'}} >{value}</span>) 
            : ''
          }
        </i>
        <div className="dropdown-menu" style={{width:'20rem'}}>
              <FaTimes 
                style={{cursor:'pointer', float:'right', paddingBottom:'5px'}} 
                onClick={hideDropdown}
              />

                {cartlist.map((x) => {
                  return (
                    <li className="dropdown-item" key={x.name}>
                      <div className="row">
                        <div className="col-8">
                          <b className="">{x.name}</b>
                          <p>{'$'+x.price}</p>
                        </div>
                        <div className="col-4">
                          <img
                            style={{ width: "90px", height: "50px" }}
                            src={processImg(x.image)}
                            alt="..."
                          />
                        </div>
                      </div>
